                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="inputName" class="form-control" name="head">
                                </div>


                                <div class="form-group">
                                    <label for="inputClientCompany">Highlighted</label>
                                    <input type="text" id="inputClientCompany" class="form-control" name="highlighted">
                                </div>

                                <div class="form-group">
                                    <label for="inputClientCompany">Body</label>
                                    <input type="text" id="inputClientCompany" class="form-control" name="body">
                                </div>
